      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {deliveryPlatforms.map((platform) => (
            <div key={platform.name} className="order-card">
              
              <div
                className="block p-6 rounded-2xl transition-all duration-300 hover:scale-[1.02] cursor-default"
                style={{
                  // I kept this as you had it, but because the main background 
                  // is now dark blue, this semi-transparent red might look different.
                  // You might want to change this to 'rgba(255, 255, 255, 0.05)' for a glass effect.
                  backgroundColor: "#a376792e", 
                }}
              >
                <div className="text-center">
                  ...
                  <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden bg-white">
                    <img
                      src={platform.logo.src || platform.logo} // Handled .src in case of Next.js static import
